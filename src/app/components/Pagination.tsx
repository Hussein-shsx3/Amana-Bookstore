    ...
    <div className="flex flex-col items-center space-y-4 mt-8">
        ...
        <button
          ...
          className={`px-3 py-2 rounded-lg border text-sm font-medium transition-colors ${
            currentPage === 1
              ...
              : "bg-white text-gray-700 border-gray-300 hover:bg-indigo-700 hover:text-white cursor-pointer"
          }`}
      ...
      <div className="flex items-center space-x-2 text-sm text-gray-600">
        ...
        <select
          ...
          className="px-2 py-1 border border-gray-300 rounded text-sm bg-white focus:outline-none focus:ring-2 focus:ring-indigo-700"
        >
