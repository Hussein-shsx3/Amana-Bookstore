...
export const books: Book[] = [
  ...
  {
    id: "46",
    title: "Celestial Cartography: Mapping the Stars",
    author: "Dr. Layla Al-Razi",
    description:
      "An illustrated guide to astronomical mapping techniques, star charts, and the evolution of celestial navigation from ancient observatories to modern telescopes.",
    price: 99.0,
    image: "/images/book3.jpg",
    isbn: "978-0467890123",
    genre: ["Astronomy", "Textbook"],
    tags: ["Star Maps", "Navigation", "Observatories"],
    datePublished: "2024-06-21",
    pages: 412,
    language: "English",
    publisher: "Copernicus Horizon Press",
    rating: 4.7,
    reviewCount: 12,
    inStock: true,
    featured: false,
